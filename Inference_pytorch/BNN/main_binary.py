...
def main():
    ...
    #     train_loader, val_loader = dataset.get_cifar10(batch_size=args.batch_size, transform_all=transform, num_workers=args.workers)
    # elif args.dataset == 'cifar100':
    #     train_loader, val_loader = dataset.get_cifar100(batch_size=args.batch_size, transform_all=transform, num_workers=args.workers)
    # elif args.dataset == 'imagenet':
    #     train_loader, val_loader = dataset.get_imagenet(batch_size=args.batch_size, transform_all=transform, num_workers=args.workers)
