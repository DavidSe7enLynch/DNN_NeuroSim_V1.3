...
from .common import conv1x1, conv3x3, binarize_conv3x3
...
class BasicBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = binarize_conv3x3(inplanes, planes, stride)
        self.bn1 = norm_layer(planes)
        self.conv2 = conv3x3(planes, planes)
        self.conv2 = binarize_conv3x3(planes, planes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv2 = binarize_conv3x3(width, width, stride, groups, dilation)
